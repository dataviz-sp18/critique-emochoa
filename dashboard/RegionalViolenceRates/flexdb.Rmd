...
***
<p align=justify><font size=4>
<b>The baseline level of violence varies by climate region.</b><br><br>
...
### Model D: Spatial Lag by Regions (Intercept) {data-commentary-width=450}
<p align=center><font size=3>
Figure 9. </font><br>
```{r frame9}
zones.map %>% addPolygons(weight = 1, color = '#000000',opacity = 1.0,fill=TRUE,fillOpacity = 0.6,
...
### Model E: Spatial Error by Regions (Intercept) {data-commentary-width=450}
